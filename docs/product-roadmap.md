...
- [x] **Coordination kernel.** Typed intents, inferred semantic scopes, all-or-ticket scheduling, durable tickets/events, service epochs, fencing, FIFO aging, and fresh-state wakeups. (PASS 2026-07-14; scheduler-level evidence: [`docs/spikes/2026-07-14-coordination-scheduler.md`](spikes/2026-07-14-coordination-scheduler.md))
