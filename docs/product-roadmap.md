...
- [ ] **N=3 directional extension.** Repeat the six-scenario round at three trials per scenario to test whether the observed paired differences hold direction under repetition. Needs its own design, independent review, and a fresh operator approval minted from main (stable-root digests). Projected ~USD 15 at observed spend against the USD 55 per-round ceiling.
